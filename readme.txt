...
**IMPORTANT NOTE** : to prepare switch to WP3.0 (3.0-beta) single or multisite (wpmu) - see [Other versions](http://wordpress.org/extend/plugins/xili-dictionary/download/). The most recent version remains compatible with current WP 2.9.x.
