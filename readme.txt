...
= NEW 0.9.7 = grouping of terms by language now possible, - better import .po - enrich terms more possible (same terms with/without html tags

THIS VERSION 0.9.7 IS A BETA VERSION (running on our sites and elsewhere) - WE NEED MORE FEEDBACK even if the first from world are good - coded as OOP and new admin UI WP 2.7 features (meta_box, js, screen options,...)
