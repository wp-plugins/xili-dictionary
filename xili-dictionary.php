...
define( 'XILIDICTIONARY_VER', '2.11.0' );
	...
	function localize_admin_js( $case_news, $news_id ) {
		...
		switch ( $case_news ) {
			...
			case 'xd_new_version' :
				...
				$pointer_text .= '<p>' . esc_js( sprintf(__( 'This version %s adds way to built only .pot files w/o using dictionary. (also tested with new WP 4.2)', 'xili-dictionary'), XILIDICTIONARY_VER) ). ',</p>';
				$pointer_text .= '<p>' . esc_js( sprintf(__( 'Previous version of %s adds ways to scan sources files (current theme or available plugins) and import translatable terms.', 'xili-dictionary'), XILIDICTIONARY_VER) ). ',</p>';
