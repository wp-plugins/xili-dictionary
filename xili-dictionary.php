...
# 2.4.0 - 131213 - WP3.7 improvements, Pre-test WP3.8 - fixes noun comment import, detect context when detecting duplicate
...
define('XILIDICTIONARY_VER','2.4.0');
...
<div style="background:#f5f5fe;">
	<div class="dialogcontainer" >
		...
		if ( in_array( $action, array ( 'export', 'importmo', 'import', 'exportpo' ) ) ) { 
			...
			<?php 
				...
				if ( 'importpluginmsgs' == $action ) {
					...
					foreach ( $domains_checking as $domain ) {
						$po = $l10n[$domain]; error_log ( serialize ( $po ) );
