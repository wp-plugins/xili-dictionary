...
define( 'XILIDICTIONARY_VER', '2.10.3' );
...
<?php
	...
	function admin_init() {
		...
		wp_register_script( 'datatables-v10', plugins_url('js/jquery.dataTables.min.js', __FILE__ ) , array( 'jquery' ), '1.10.5', true );
		//wp_register_style( 'table_xdstyle', plugins_url('/css/xd_table.css', __FILE__ ), array(), XILIDICTIONARY_VER, 'screen' );
		wp_register_style( 'table_style-v10', plugins_url('/css/jquery.dataTables.min.css', __FILE__ ), array(), XILIDICTIONARY_VER, 'screen' );
	}
