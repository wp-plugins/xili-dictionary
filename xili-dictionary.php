...
define('XILIDICTIONARY_VER','1.4.1');
			...
			<tr class="form-field">
				...
				<td>
					<fieldset style="margin:2px; padding:10px 5px; border:1px solid #ccc;"><legend><?php
					 ...
					 ?></legend>
			  			<?php if ( isset( $dictioline )  ) $this->xili_select_row( $term_id, $dictioline ); /* choice of parent line */?>
			  		</fielset>
             	</td>
			</tr>
			<tr>
	 ...
	 */
	 ...
	 function xd_wp_set_object_terms( $term_id, $lang_slug, $taxo_dictgroup , $bool = false) {
	 	...
	 	if ( !$term_info = term_exists($lang_slug, $taxo_dictgroup) ) {
			...
			$term_info = wp_insert_term($lang_slug, $taxo_dictgroup, $args); 
		}
