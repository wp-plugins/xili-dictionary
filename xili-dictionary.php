...
define('XILIDICTIONARY_VER','1.0.1');
...
class xili_dictionary {
	...
	function xili_add_js() {
		wp_enqueue_script( 'xd-plural', '/'.PLUGINDIR.'/'.dirname(plugin_basename(__FILE__)).'/plural.js', array('jquery'), XILIDICTIONARY_VER);
	}
		...
		<table class="editform" width="100%" cellspacing="2" cellpadding="5">
			...
			<?php if ($action=='edit') { 
				...
				<div id="input1" style="margin-bottom:4px;" class="clonedInput">
				  ...
				  <textarea style="visibility:visible" class="plural" name="dictioline_description1" id="dictioline_description1" cols="50" rows="3"  <?php echo $noedit; ?> ></textarea>
