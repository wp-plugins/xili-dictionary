...
define('XILIDICTIONARY_VER','2.6.0');
...
<div id="xili-dictionary-settings" class="wrap columns-2" style="min-width:850px">
	...
	function pomo_import_PO ( $lang = "", $local = false ) {
		...
		if ( $local == false ) {
			$pofile = $this->active_theme_directory.$langfolder.$lang.'.po'.$t;
		} else {
			$pofile = $this->active_theme_directory.$langfolder.'local-'.$lang.'.po'; // fixed 2.1.1
		}
